...
nextDMS is an innovative cloud-based Document Management System (DMS) designed to streamline the storage, organization, and management of documents in the cloud.
...
To build the final jar and optimize the nextDms application for production, run:
