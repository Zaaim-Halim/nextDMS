...
import io.nextdms.app.security.*;
import io.nextdms.app.security.AuthoritiesConstants;
import io.nextdms.app.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/explorer/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.EXPLORER)
